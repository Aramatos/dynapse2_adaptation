...
def neuron_configs_DC():
    neuron_config={
        ...
        'in_DC':200,#for single neuron tests
        ...
        'sweep_variable':'PV_AMPA_TAU',#variable to sweep
        'sweep_coarse_val':1,
        'sweep_range_fine':np.linspace(0,250,5,dtype=int),
        #Main Settings
        'PC_Adaptation':False,
        'STD':False,
        #DC level for pulse test
        'DC_pulse':[3,250],
        #Probabilities
        'Input_PC':.8,
        'Input_PV':.1,
        ...
        'PC_AMPA_TAU':[1,130], #5 msinput ampa synapse timesconat 
        'PC_AMPA_GAIN':[4,250], 
